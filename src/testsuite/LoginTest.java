...
public class LoginTest extends BaseTest {
    ...
    public void userShouldLoginSuccessfullyWithValidCredentials() {
            ...
            driver.findElement(By.name("login[username]")).sendKeys("amruta123@gmail.com");

            //find password field and enter password
            driver.findElement(By.name("login[password]")).sendKeys("Amruta@12");
            ...
            //verify text
            String expectedText = "Welcome, amruta goswami!";
            String actualText = driver.findElement(By.xpath("(//li[@class='greet welcome']//span[contains(text(),'Welcome, amruta goswami!')])[1]")).getText();
        ...
        public void verifyTheErrorMessageWithInvalidCredentials(){
            ...
            //find password field and enter password
            driver.findElement(By.name("login[password]")).sendKeys("Amruta@123");
    ...
    public void userShouldLogOutSuccessfully(){
            ...
            String actualText = driver.findElement(By.xpath("(//li[@class='greet welcome']//span[contains(text(),'Welcome, amruta goswami!')])[1]")).getText();
            Assert.assertEquals(expectedText, actualText);
            //find the down aero near wel come
